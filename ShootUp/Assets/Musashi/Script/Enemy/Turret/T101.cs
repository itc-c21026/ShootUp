...
public class T101 : MonoBehaviour
{
    GameObject Player;
    ...
    void Start()
    {
        ...
        Mystatus = TurretController.GetComponent<TurretController>().TypeB1;
    ...
    IEnumerator Shot()
    {
        GameObject T_Bullet = Instantiate(TurretBullet, My_Muzzle.transform.position, My_Muzzle.transform.rotation);
        ...
        T_Bullet = Instantiate(TurretBullet, My_Muzzle.transform.position, My_Muzzle.transform.rotation);
        T_Bullet.GetComponent<TurretBullet>().Damage = float.Parse(Mystatus[2]);
        T_Bullet.GetComponent<TurretBullet>().Speed = float.Parse(Mystatus[5]);
        yield return new WaitForSeconds(0.2f);
        T_Bullet = Instantiate(TurretBullet, My_Muzzle.transform.position, My_Muzzle.transform.rotation);
